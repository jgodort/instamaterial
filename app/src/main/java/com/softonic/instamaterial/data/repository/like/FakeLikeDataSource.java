...
public class FakeLikeDataSource implements LikeDataSource {
  ...
  public FakeLikeDataSource() {
    mapPhotoLikes.put(PHOTO_ID1, new LinkedList<>(
        Arrays.asList(Like.Builder().photoId(PHOTO_ID1).userId(USER_ID2).build(),
    ...
    mapPhotoLikes.put(PHOTO_ID2, new LinkedList<>(
        Arrays.asList(Like.Builder().photoId(PHOTO_ID2).userId(USER_ID1).build(),
