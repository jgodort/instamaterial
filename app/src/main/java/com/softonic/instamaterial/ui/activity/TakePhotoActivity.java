...
public class TakePhotoActivity extends BaseActivity
  ...
  @BindView(R.id.vPhotoRoot) View vTakePhotoRoot;
  @BindView(R.id.vShutter) View vShutter;
  @BindView(R.id.ivTakenPhoto) ImageView ivTakenPhoto;
  @BindView(R.id.vUpperPanel) View vUpperPanel;
  @BindView(R.id.vLowerPanel) View vLowerPanel;
  ...
  @OnClick(R.id.btnTakePhoto) public void onTakePhotoClick() {
    btnTakePhoto.setEnabled(false);
    cameraView.takePicture(true, true);
    animateShutter();
  }

  @OnClick(R.id.btnCancel) public void onCancelClick() {
    finish();
  }
