...
public class CommentsActivity extends BaseActivity
    implements SendCommentButton.OnSendClickListener, CommentsPresenter.View {
  ...
  @BindView(R.id.llNoComments) LinearLayout llNoComments;
  ...
  @BindView(R.id.flUploading) FrameLayout flUploading;
  ...
  @Override public void showErrorWhileRequestingComments() {
    Snackbar.make(contentRoot, R.string.comments_cannot_request_comments,
  ...
  @Override public void showErrorWhileUploading() {
    uploading = false;
    flUploading.setVisibility(View.GONE);
    Snackbar.make(findViewById(R.id.root), R.string.comments_cannot_publish_comment,
        Snackbar.LENGTH_INDEFINITE).setAction(R.string.action_retry, new View.OnClickListener() {
      @Override public void onClick(View v) {
  ...
  @Override public void onSendClickListener(View v) {
    if (validateComment()) {
      commentsPresenter.requestPublishComment(photoId, etComment.getText().toString());
