...
public class LoginActivity extends BaseActivity implements LoginPresenter.View {
  ...
  @BindView(R.id.contentRoot) LinearLayout llContentView;
  ...
  @Override public void showErrorWhileLoggingIn(String error) {
  ...
  @OnClick(R.id.btnSingIn) public void onSignInClick() {
    loginPresenter.requestLogin(RC_SIGN_IN);
  }
}
