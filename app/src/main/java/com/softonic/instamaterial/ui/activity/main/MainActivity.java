...
public class MainActivity extends BaseActivity
  ...
  @BindView(R.id.clContent) CoordinatorLayout clContent;
  @BindView(R.id.rvFeed) RecyclerView rvFeed;
  @BindView(R.id.btnCreate) FloatingActionButton fabCreate;
  @BindView(R.id.pbLoading) ProgressBar pbLoading;
  @BindView(R.id.llNoElements) LinearLayout llNoElements;
  ...
  @Override public void setupFeed(String userId) {
  ...
  @Override public void addFeedItem(final FeedItem feedItem) {
    llNoElements.setVisibility(View.GONE);
  ...
  @Override public void showErrorWhileRequestingFeed() {
    ...
    Snackbar.make(findViewById(R.id.root), R.string.feed_cannot_request_elements,
  ...
  @Override public void showErrorWhileLikingPhoto() {
    Snackbar.make(findViewById(R.id.root), R.string.feed_cannot_send_action,
        Snackbar.LENGTH_INDEFINITE).show();
  }

  @Override public void showErrorWhileUpdatingFeed() {
    Snackbar.make(findViewById(R.id.root), R.string.feed_error_updating_feed,
        Snackbar.LENGTH_INDEFINITE).show();
  }
  ...
  @Override public void showErrorWhileSigningOut() {
    Snackbar.make(findViewById(R.id.root), R.string.user_logged_out_error,
        Snackbar.LENGTH_INDEFINITE).setAction(R.string.action_retry, new View.OnClickListener() {
      @Override public void onClick(View v) {
  ...
  @Override public void onLikeClick(FeedItem feedItem, int likeSource) {
    mainPresenter.onRequestLike(feedItem.getPhotoId(), likeSource);
  }

  @Override public void onCommentsClick(View v, FeedItem feedItem) {
    final Intent intent = CommentsActivity.getCallingIntent(this, feedItem.getPhotoId(),
  ...
  @OnClick(R.id.btnCreate) public void onTakePhotoClick() {
    int[] startingLocation = new int[2];
