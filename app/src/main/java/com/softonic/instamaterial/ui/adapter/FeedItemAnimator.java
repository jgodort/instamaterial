...
public class FeedItemAnimator extends DefaultItemAnimator {
  ...
  private void incrementLikesCounter(FeedAdapter.CellFeedViewHolder holder, int counter) {
    ...
    String likesCountTextFrom = holder.tsLikesCounter.getResources()
        .getQuantityString(R.plurals.likes_count, counter - 1, counter - 1);
    holder.tsLikesCounter.setCurrentText(likesCountTextFrom);

    String likesCountTextTo = holder.tsLikesCounter.getResources()
        .getQuantityString(R.plurals.likes_count, counter, counter);
